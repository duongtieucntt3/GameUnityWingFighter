...
public class ItemLooter : InventoryAbstract
{
    ...
    protected virtual void OnTriggerEnter(Collider collider)
    {
        ...
        {
            if(itemInventory.itemProfile.itemName== "SpreadShot")
            {
                inventory.ShipCtrl.ObjShooting_2.gameObject.SetActive(true);
                inventory.ShipCtrl.ObjShooting_3.gameObject.SetActive(true);
                inventory.ShipCtrl.ObjShooting.shootDelay = 0.25f;
            }
